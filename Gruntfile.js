// Generated on 2013-09-20 using generator-bespoke v0.3.1
...
module.exports = function(grunt) {
  ...
  var config = {
    ...
    watch: {
      ...
      less: {
        files: '<%= less.src.files[0].cwd + less.src.files[0].src %>',
        tasks: 'less'
      },
      coffee: {
      ...
      copy: {
        files: [
          ...
          '!<%= less.src.files[0].cwd + less.src.files[0].src %>',
